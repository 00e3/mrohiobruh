...
public:
	...
	void ProcessImpacts() {
		typedef void(__thiscall* ProcessImpactsFN)(void*);
		return util::get_method< ProcessImpactsFN >(this, 4)(this);
	}
...
public:
	...
	void CheckMovingGround(Entity* entity, double frametime) {
		typedef void(__thiscall* CheckMovingGroundFN)(void*, Entity*, double);
		return util::get_method< CheckMovingGroundFN >(this, 18)(this, entity, frametime);
	}
