...
namespace callbacks {
	...
	bool projectile1();
	bool bullet_impactz();
	bool bullet_impactz1();
	bool impact_beams_enabled();
	bool spread_xhair_enabled();
	bool fov_enabled();
	bool worldenabled();
	bool dropped_weapon();
	bool grenade_trajectoryenabled();
	bool skyenabled();
	bool viewmodel_enabled();
	bool thirdpersonbind();
	bool bullet_impactz2();
	void SkinUpdate( );
