...
namespace render {
	...
	void rect(vec2_t pos, vec2_t dim, Color color);
	void rect_filled(vec2_t pos, vec2_t dim, Color color);
	void rect_filled_fade(vec2_t pos, vec2_t dim, Color color, int a1, int a2);
	void rect_outlined(vec2_t pos, vec2_t dim, Color color, Color color2);
	...
	void flat_sphere( vec3_t origin, float radius, float angle, float scale, Color color );
