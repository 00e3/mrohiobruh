...
void Edit::draw() {
	...
	// inner blob
	// todo; gradient?
	render::rect_filled(p.x + EDIT_X_OFFSET + 1, p.y + 15 + 1, m_w - EDIT_X_OFFSET - 1, EDIT_BOX_HEIGHT - 2, { 41, 41, 41, m_parent->m_alpha });

	render::menu.string(p.x + EDIT_X_OFFSET + 10, p.y + 15 + 4, { 152, 152, 152, m_parent->m_alpha }, m_text);
