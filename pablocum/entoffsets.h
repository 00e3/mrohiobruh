...
public:
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_vecAbsOrigin;
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_angAbsAngles;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_nComputedLODframe;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flGravity;
...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
		...
		INIT_XOREDNETVAR( m_flGravity, HASH( "DT_BasePlayer" ), HASH( "m_flGravity" ) );
		...
		INIT_XOREDNETVAR_SPECIFIC( m_surfaceFriction, 0x3210 );
		INIT_XOREDNETVAR_SPECIFIC( m_nComputedLODframe, 0xA30 );
		INIT_XOREDNETVAR_SPECIFIC( m_angAbsRotation, 196 );
		INIT_XOREDNETVAR_SPECIFIC( m_vecAbsOrigin, 160 );
		INIT_XOREDNETVAR_SPECIFIC( m_angAbsAngles, 0xC4 );
