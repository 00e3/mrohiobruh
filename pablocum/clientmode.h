...
enum post_process_parameters_names_t
{
	PPPN_FADE_TIME = 0,
...
struct post_process_parameters_t
{
	post_process_parameters_t( )
	{
		memset( m_parmeters, 0, sizeof( m_parmeters ) );
		m_parmeters[ PPPN_VIGNETTE_START ] = 0.8f;
		m_parmeters[ PPPN_VIGNETTE_END ] = 1.1f;
	}

	float m_parmeters[ POST_PROCESS_PARAMETER_COUNT ];
};
